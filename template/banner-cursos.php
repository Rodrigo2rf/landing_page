<section id="info-cursos" class="container-fluid bg-cursos">
    ...
    <div id="trocar-modalidade" class="row justify-content-center menu-de-cursos">
        <a href="<?=url_cur_tecnico?>" class="link-menu-de-cursos dv-3 col-md-3 text-center <?php if($id_cursos >= 7 && $id_cursos <= 9){ echo 'ativo'; }?>">
            Cursos<br>Técnicos
        </a>
        <a href="<?=url_cur_posgraduacao?>" class="link-menu-de-cursos dv-3 col-md-3 text-center <?php if($id_cursos >= 10 && $id_cursos <= 12){ echo 'ativo'; }?>">
            Cursos<br>Pós-Graduação
        </a>
        <a href="<?=url_cur_atualizacao?>" class="link-menu-de-cursos dv-3 col-md-3 text-center <?php if($id_cursos >= 13 && $id_cursos <= 15){ echo 'ativo'; }?>"> 
